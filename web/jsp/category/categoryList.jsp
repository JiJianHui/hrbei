...
<s:iterator value="companies" id="company">
    <div id="light<s:property value="#company.id"/>" class="white_content">

        <div class="briefInfo">
            <div class="briefHead">
                <div class="briefHeadLeft">认证商家资料---<s:property value="#company.name"/></div>
                <div class="briefHeadRight">
                    <a href="javascript:void(0)" onclick="document.getElementById('light<s:property value="#company.id"/>').style.display='none';
            ...
            <div class="briefPrice">
                ...
                <div class="briefPriceRight">在线咨询<img src="/images/tixing.jpg"/>
                    <a href="tencent://message/?uin=825196587">QQ留言<img src="/images/qq.gif"></a></div>
            </div>
            ...
            <div class="briefPriceTable">
                <table class="priceTable">
                    ...
                    <s:iterator value="#company.products" id="companyProducts" status="st">
                        <s:if test="#st.index<10" >
                            <tr>
                                <td class="tdNormal">
                                    <a href="productBlog.html?product.id=<s:property value="#companyProducts.id"/>">
                                        <s:property value="#companyProducts.name"/></a>
                                </td>
                ...
                <div style="text-align: right;width: 100%;">
                    <a href="companyBlog.html?company.id=<s:property value="#company.id"/>" >
                    更多产品信息请进入企业店铺>>
                    </a>
                </div>
            </div>
            ...
            <div class="briefFooter">
                <div class="footerItem"><span>地&nbsp;&nbsp;&nbsp;址:</span><s:property value="#company.address"/></div>
                <div class="footerItem"><span>联系人:</span><s:property value="#company.contactName"/></div>
                <div class="footerItem"><span>固&nbsp;&nbsp;&nbsp;话:</span><s:property value="#company.phone"/></div>
                <div class="footerItem"><span>手&nbsp;&nbsp;&nbsp;机:</span><s:property value="#company.mobilePhone"/></div>
                <div class="footerItem"><span>邮&nbsp;&nbsp;&nbsp;箱:</span><s:property value="#company.email"/></div>
            </div>
