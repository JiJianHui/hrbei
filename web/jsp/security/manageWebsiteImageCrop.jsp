...
//                    real_path = real_path.replace("/upload/file/tmp",data);
                    window.parent.window.document.getElementById("productLogo<s:property value="imageIndex"/>").src = real_path;
//                    window.parent.window.document.getElementById("usermenu_user_img").src = real_path;
                    window.parent.window.document.getElementById("picHidden<s:property value="imageIndex"/>").value = userPortraitName;
